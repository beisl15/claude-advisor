...
`"PETR4":"PETROLEO BRASILEIRO", "ABEV3":"AMBEV", "ITUB4":"ITAU UNIBANCO"`.
...
fontes que a sandbox local bloqueia (SEC, B3, Yahoo, FINRA).

## Cobertura descontinuada
Nomes que saíram do universo têm a ficha de research preservada em
`archive/deprecated_coverage/` (VALE3, TOTS3, CSMG3). Reativar é devolver os blocos
listados no fim de cada `.md`.
